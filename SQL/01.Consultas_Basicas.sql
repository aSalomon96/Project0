...
select t."Name" as "track_title", "Milliseconds" 
from "Track" t 
where 
	"Milliseconds" > 300000
...
from "Track" t
where 
	"Milliseconds" > 300000 and "UnitPrice" > 1;
...
-- Ejercicio 14: Lista las pistas que tienen una duración mayor a 250,000 milisegundos y 
-- pertenecen a un tipo de medio con ID 1 o 2. Muestra el nombre de la pista y el tipo de medio.
select 	
	t."Name" as "Track_name",
	mt."Name" as "MediaTypeId"
from "Track" t 
inner join 
	 "MediaType" mt ON t."MediaTypeId" = mt."MediaTypeId"
where 
    t."Milliseconds" > 250000
    AND (t."MediaTypeId" = 1 OR t."MediaTypeId" = 2);